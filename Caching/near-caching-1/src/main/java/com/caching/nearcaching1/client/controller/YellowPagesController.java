package com.caching.nearcaching1.client.controller;

import com.caching.nearcaching1.client.model.Person;
import com.caching.nearcaching1.client.service.YellowPageService;
...
public class YellowPagesController {
    ...
    @Autowired
    private YellowPageService yellowPages;
